export default function Example() {
    return (
        <footer class="text-center lg:text-left bg-gray-400 text-gray-600">
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
        Konsep XoS menawarkan fashion dan kualitas dengan harga terbaik dan cara yang berkelanjutan. Sejak didirikan pada 2022, XoS telah menjadi salah satu. Seluruh isi dan informasi dari 
        situs ini dilindungi hak cipta dan merupakan milik XoS.
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Returns & Refunds</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Terms & Conditions</a>
        </p>
        <p>
  ...
  <div class="text-center p-6 bg-gray-400">
    <span>© 2022:</span>
    <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">XoS Shop</a>
  </div>
</footer>
    )
}